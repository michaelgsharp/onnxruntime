...
# |  Generated on: 2019-11-22 10:53:50.226732
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
# |
# ----------------------------------------------------------------------
featurizers_TypeInfo                                                        = ClassTypeInfo(OrderedDict([ ( "name", StringTypeInfo(min_length=1) ), ( "estimator_name", StringTypeInfo(min_length=1) ), ( "num_output_columns", IntTypeInfo(min=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "status", EnumTypeInfo([ 'Pending', 'External', 'Available', ], arity=Arity.FromString('?')) ), ( "creates_annotations", BoolTypeInfo(arity=Arity.FromString('?')) ), ( "custom_structs", ClassTypeInfo(OrderedDict([ ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "members", ClassTypeInfo(OrderedDict([ ( "type", StringTypeInfo(min_length=1) ), ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ) ]), require_exact_match=True, arity=Arity.FromString('+')) ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "configuration_params", ClassTypeInfo(OrderedDict([ ( "type", StringTypeInfo(min_length=1) ), ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "is_optional", BoolTypeInfo(arity=Arity.FromString('?')) ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "templates", ClassTypeInfo(OrderedDict([ ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "types", StringTypeInfo(min_length=1, arity=Arity.FromString('+')) ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "input_description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "output_description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "is_input_a_template", BoolTypeInfo(arity=Arity.FromString('?')) ), ( "is_output_a_template", BoolTypeInfo(arity=Arity.FromString('?')) ), ( "type_mappings", ClassTypeInfo(OrderedDict([ ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "input_type", StringTypeInfo(min_length=1) ), ( "is_input_optional", BoolTypeInfo(arity=Arity.FromString('?')) ), ( "output_type", StringTypeInfo(min_length=1) ), ( "is_output_optional", BoolTypeInfo(arity=Arity.FromString('?')) ) ]), require_exact_match=True, arity=Arity.FromString('*')) ) ]), require_exact_match=True, arity=Arity.FromString('+'))

_featurizers_TypeInfo_Contents                                              = OrderedDict([("name", GenericTypeInfo()), ("estimator_name", GenericTypeInfo()), ("num_output_columns", GenericTypeInfo()), ("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("status", GenericTypeInfo(arity=Arity.FromString('?'))), ("creates_annotations", GenericTypeInfo(arity=Arity.FromString('?'))), ("custom_structs", GenericTypeInfo(arity=Arity.FromString('*'))), ("configuration_params", GenericTypeInfo(arity=Arity.FromString('*'))), ("templates", GenericTypeInfo(arity=Arity.FromString('*'))), ("input_description", GenericTypeInfo(arity=Arity.FromString('?'))), ("output_description", GenericTypeInfo(arity=Arity.FromString('?'))), ("is_input_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("is_output_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("type_mappings", GenericTypeInfo(arity=Arity.FromString('*')))])
_featurizers_custom_structs_TypeInfo_Contents                               = OrderedDict([("name", GenericTypeInfo()), ("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("members", GenericTypeInfo(arity=Arity.FromString('+')))])
_featurizers_custom_structs_members_TypeInfo_Contents                       = OrderedDict([("type", GenericTypeInfo()), ("name", GenericTypeInfo()), ("description", GenericTypeInfo(arity=Arity.FromString('?')))])
_featurizers_configuration_params_TypeInfo_Contents                         = OrderedDict([("type", GenericTypeInfo()), ("name", GenericTypeInfo()), ("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("is_optional", GenericTypeInfo(arity=Arity.FromString('?')))])
...
class Deserializer(object):
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def featurizers_custom_structs_description(cls, item):
        return cls.Description(item)
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def featurizers_custom_structs_members_description(cls, item):
        return cls.Description(item)
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def featurizers_configuration_params_description(cls, item):
        return cls.Description(item)
    ...
    def _featurizers_Item(cls, item, always_include_optional, process_additional_data):
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"name", "estimator_name", "num_output_columns", "description", "status", "creates_annotations", "custom_structs", "configuration_params", "templates", "input_description", "output_description", "is_input_a_template", "is_output_a_template", "type_mappings"},
            )
    ...
    def _featurizers_custom_structs_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # description
        try:
            cls._ApplyOptionalChild(item, "description", result, cls.featurizers_custom_structs_description, always_include_optional, default_value_func=lambda: StringSerialization.DeserializeItem(_Description_TypeInfo, ""))
        except:
            _DecorateActiveException("description")
    ...
    def _featurizers_custom_structs_name_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_custom_structs_name_TypeInfo, item, **{})
    ...
    def _featurizers_custom_structs_members_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # type
        try:
            attributes["type"] = cls.featurizers_custom_structs_members_type(
                cls._GetPythonAttribute(
                    item,
                    "type",
                    is_optional=False,
        ...
        # name
        try:
            attributes["name"] = cls.featurizers_custom_structs_members_name(
                cls._GetPythonAttribute(
                    item,
                    "name",
                    is_optional=False,
        ...
        # description
        try:
            cls._ApplyOptionalChild(item, "description", result, cls.featurizers_custom_structs_members_description, always_include_optional, default_value_func=lambda: StringSerialization.DeserializeItem(_Description_TypeInfo, ""))
        except:
            _DecorateActiveException("description")
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"type", "name", "description"},
            )
    ...
    def _featurizers_custom_structs_members_type_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_custom_structs_members_type_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _featurizers_custom_structs_members_name_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_custom_structs_members_name_TypeInfo, item, **{})
    ...
    def _featurizers_configuration_params_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # type
        try:
            attributes["type"] = cls.featurizers_configuration_params_type(
                cls._GetPythonAttribute(
                    item,
                    "type",
                    is_optional=False,
        ...
        # name
        try:
            attributes["name"] = cls.featurizers_configuration_params_name(
                cls._GetPythonAttribute(
                    item,
                    "name",
                    is_optional=False,
        ...
        # is_optional
        try:
            cls._ApplyOptionalAttribute(item, "is_optional", attributes, cls.featurizers_configuration_params_is_optional, always_include_optional, default_value_func=lambda: StringSerialization.DeserializeItem(_featurizers_configuration_params_is_optional_TypeInfo, "false"))
        except:
        ...
        # description
        try:
            cls._ApplyOptionalChild(item, "description", result, cls.featurizers_configuration_params_description, always_include_optional, default_value_func=lambda: StringSerialization.DeserializeItem(_Description_TypeInfo, ""))
        except:
            _DecorateActiveException("description")
    ...
    def _featurizers_configuration_params_type_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_configuration_params_type_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _featurizers_configuration_params_name_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_configuration_params_name_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _featurizers_configuration_params_is_optional_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_configuration_params_is_optional_TypeInfo, item, **{})
